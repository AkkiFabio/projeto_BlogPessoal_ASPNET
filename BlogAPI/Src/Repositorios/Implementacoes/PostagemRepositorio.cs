...
namespace BlogAPI.Src.Repositorios.Implementacoes
{
    ...
    public class PostagemRepositorio : IPostagem
    {
        ...
        /// <summary>
        /// <para>Resumo: Método assíncrono para buscar uma postagem pelo id</para>
        /// </summary>
        /// <param name="id">Construtor para buscar uma postagem pelo id</param>
        ...
        /// <summary>
        /// <para>Resumo: Método assíncrono para criar uma nova postagem</para>
        /// </summary>
        /// <param name="postagem">Construtor para criar uma postagem</param>
        public async Task NovaPostagemAsync(Postagem postagem)
        {
            ...
            await _contexto.Postagens.AddAsync(
                new Postagem
                {
                    ...
                    Foto = postagem.Foto,
                    Criador = await _contexto.Usuarios.FirstOrDefaultAsync(t => t.Id == postagem.Criador.Id),
        ...
        /// </summary>
        /// <param name="postagem">Construtor para atualizar uma postagem</param>
        ...
        /// <summary>
        /// <para>Resumo: Método assíncrono para deletar uma postagem pelo id</para>
        /// </summary>
        /// <param name="id">Construtor para deletar uma postagem</param>
